...
call reportgenerator "-title:Farm Management Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-title:Farm Management Library Test Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_test_win.info" "-targetdir:docs/coverxygentestwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_win"
...
call reportgenerator "-targetdir:assets/codecoveragelibwin" "-reporttypes:Badges" "-reports:**/farm_management_app_unit_win_cobertura.xml" "-sourcedirs:src/farm_management_lib/src;src/farm_management_lib/include;src/farm_management_app/src;src/farm_management_app/include;src/tests/farm_management" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
echo Package Publish Windows Binaries
call robocopy src\farm_management_lib\include "build_win\build\Release" /E
call robocopy src\farm_management_app\include "build_win\build\Release" /E
